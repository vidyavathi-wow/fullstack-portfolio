...
const { validateBookCreation, validateBookIdParam } = require("../middlewares/validators.js");
...
router.put("/:id", validateBookIdParam.concat(validateBookCreation), bookController.updateBook);
